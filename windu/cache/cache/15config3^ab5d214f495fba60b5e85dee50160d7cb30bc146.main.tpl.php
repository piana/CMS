...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_555da18e757d47_50985737',
  'has_nocache_code' => true,
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_555da18e757d47_50985737')) {function content_555da18e757d47_50985737($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_function_L')) include 'C:\\xampp\\htdocs\\windu/data/functions\\function.L.php';
?><!DOCTYPE html>
<html>
	<head>
...
<ul class="menu accordion" id="leftMenu">
	    ...
	    <div id="leftMenuConfig" class="accordion-body collapse in">
      		<div class="accordion-inner">
				<ul>
									    				    <li ><a href="http://localhost/windu/admin/config/0/"><i class="color-icons icons-gear icon-margin">&nbsp;</i><span class="menu-description">Ogólny</a></li>
				    				    ...
				    				    <li class="active"><a href="http://localhost/windu/admin/config/3/"><i class="color-icons icons-gear icon-margin">&nbsp;</i><span class="menu-description">Grafika</a></li>
