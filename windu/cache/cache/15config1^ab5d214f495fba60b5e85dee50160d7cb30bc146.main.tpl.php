...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_555da199251262_78777633',
  'has_nocache_code' => true,
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_555da199251262_78777633')) {function content_555da199251262_78777633($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_function_L')) include 'C:\\xampp\\htdocs\\windu/data/functions\\function.L.php';
?><!DOCTYPE html>
<html>
	<head>
	    ...
	    <div id="leftMenuConfig" class="accordion-body collapse in">
      		<div class="accordion-inner">
				<ul>
				    				    ...
				    				    <li class="active"><a href="http://localhost/windu/admin/config/1/"><i class="color-icons icons-gear icon-margin">&nbsp;</i><span class="menu-description">Treść</a></li>
