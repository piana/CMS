...
class simpleCaptcha {
    ...
    public $session_var = 'captchaCode';
    ...
    public function CreateImage() {
        ...
        cookie::setCookie($this->session_var,md5(sha1($text)));
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        $fontfile = __SITE_PATH.'/app/plugins/html/'.$this->resourcesPath.'/fonts/'.$fontcfg['font'];
