...
<script type="text/javascript" src="{$HOME}app/plugins/image/resources/blueimp-jQuery-File-Upload/js/mainFile.js"></script>
<!--[if gte IE 8]><script src="{$HOME}app/plugins/image/resources/blueimp-jQuery-File-Upload/js/cors/jquery.xdr-transport.js"></script><![endif]-->
	...
	<form id="fileupload" action="{$HOME}fileServerJsUpload/{$bucket}/" method="POST" enctype="multipart/form-data">
